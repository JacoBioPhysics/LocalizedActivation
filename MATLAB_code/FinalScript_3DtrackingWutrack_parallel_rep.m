...
frames_separators={'2','1500'};
datasetname='1020_offONON_stimulus'
saveroot=strcat('C:\Users\solari\Desktop\',datasetname,'\');
...
for j=1:Nfolder
    ...
    PrepareImagesForUtrack_rep ... %call the actual function that does the job
            (folderlist{j},all_target_folders{j}, frames_separators{1}, frames_separators{2});
