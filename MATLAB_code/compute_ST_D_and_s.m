function [D,s,SNR, var, varnormal] = compute_ST_D_and_s(track,pixelsize,varsigma)
    ...
    varnormal=D^2*(2 + 4*e + 3*e^2)/( N*(1 - 2*R)^2 ) ;%+ varsigma/( (1 - 2*R)^2*framelength^2 );
